...
%let country  = Mozambique;    * country name;

%let survey   = insida2021; * survey prefix;
...
/*******************************************************************************
  3. Formating variables
     ...
     ---Approach 2. Using the PHIA permanent format library
		 This example assumes that the SAS program "INSIDA 2021 SAS Formats.sas" has been run. 
