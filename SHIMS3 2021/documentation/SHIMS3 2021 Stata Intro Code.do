...
*global country "Eswatini"  //country name
*global survey shims32021	//survey prefix
*global weights "98" 		//Number of survey-specific jackknife replicate weights
...
//Adultbio
use "shims32021adultbio.dta", clear
...
use "shims32021adultind.dta", clear
merge 1:1 personid using shims32021adultbio.dta
tab _merge 
drop _merge
...
use "shims32021hh.dta", clear
merge 1:m householdid using shims32021roster.dta

//Many-to-one
//Merge the individual dataset with the household dataset and only keep eligible and responding people
use "shims32021adultind.dta", clear
merge m:1 householdid using shims32021hh.dta
tab _merge 
drop _merge
