...
%let country  = Eswatini;    * country name;

%let survey   = shims32021; * survey prefix;

%let numreps  = 098;        * the number of Jackknife replicate weights for the survey;
...
/*******************************************************************************
  3. Formating variables
     ...
     ---Approach 2. Using the PHIA permanent format library
		 This example assumes that the SAS program "SHIMS3 2021 SAS Formats.sas" has been run. 
