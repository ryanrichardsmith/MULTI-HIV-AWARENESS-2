...
# 3. Read in data
#SAS file type
  hh        <- import ("shims32021hh.sas7bdat")
  roster    <- import ("shims32021roster.sas7bdat")
  adultind  <- import("shims32021adultind.sas7bdat")
  adultbio  <- import("shims32021adultbio.sas7bdat")

#csv file type
  #hh       <- read.csv("shims32021hh.csv", header = TRUE)
  #roster   <- read.csv("shims32021roster.csv", header = TRUE)
  #adultind <- read.csv("shims32021adultind.csv", header = TRUE)
  #adultbio <- read.csv("shims32021adultbio.csv", header = TRUE)
