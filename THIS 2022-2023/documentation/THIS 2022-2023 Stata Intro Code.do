...
*global country "Tanzania" //country name
*global survey this2022 			//survey prefix
*global weights "277" 		//Number of survey-specific jackknife replicate weights
...
//Adultbio
use "this2022adultbio.dta", clear
...
use "this2022adultind.dta", clear
merge 1:1 personid using this2022adultbio.dta
tab _merge 
drop _merge
...
use "this2022hh.dta", clear
merge 1:m householdid using this2022roster.dta

//Many-to-one
//Merge the individual dataset with the household dataset and only keep eligible and responding people
use "this2022adultind.dta", clear
merge m:1 householdid using this2022hh.dta
tab _merge 
drop _merge
