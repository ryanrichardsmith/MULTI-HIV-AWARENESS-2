...
*global country "Malawi" //country name
*global survey mphia2020 			//survey prefix
*global weights "217" 		//Number of survey-specific jackknife replicate weights
...
//Adultbio
use "mphia2020adultbio.dta", clear
...
use "mphia2020adultind.dta", clear
merge 1:1 personid using mphia2020adultbio.dta
tab _merge 
drop _merge
...
use "mphia2020hh.dta", clear
merge 1:m householdid using mphia2020roster.dta

//Many-to-one
//Merge the individual dataset with the household dataset and only keep eligible and responding people
use "mphia2020adultind.dta", clear
merge m:1 householdid using mphia2020hh.dta
tab _merge 
drop _merge
