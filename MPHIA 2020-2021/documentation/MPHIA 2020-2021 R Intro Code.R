...
# 3. Read in data
#SAS file type
  hh        <- import ("mphia2020hh.sas7bdat")
  roster    <- import ("mphia2020roster.sas7bdat")
  adultind  <- import("mphia2020adultind.sas7bdat")
  adultbio  <- import("mphia2020adultbio.sas7bdat")

#csv file type
  #hh       <- read.csv("mphia2020hh.csv", header = TRUE)
  #roster   <- read.csv("mphia2020roster.csv", header = TRUE)
  #adultind <- read.csv("mphia2020adultind.csv", header = TRUE)
  #adultbio <- read.csv("mphia2020adultbio.csv", header = TRUE)
