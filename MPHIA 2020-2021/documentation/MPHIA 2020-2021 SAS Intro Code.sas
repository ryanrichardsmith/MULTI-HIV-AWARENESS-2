...
%let country  = Malawi;    * country name;

%let survey   = mphia2020; * survey prefix;

%let numreps  = 217;        * the number of Jackknife replicate weights for the survey;
...
/*******************************************************************************
  3. Formating variables
     ...
     ---Approach 2. Using the PHIA permanent format library
		 This example assumes that the SAS program "MPHIA 2020-2021 SAS Formats.sas" has been run. 
