...
# 3. Read in data
#SAS file type
  hh        <- import ("uphia2020hh.sas7bdat")
  roster    <- import ("uphia2020roster.sas7bdat")
  adultind  <- import("uphia2020adultind.sas7bdat")
  adultbio  <- import("uphia2020adultbio.sas7bdat")

#csv file type
  #hh       <- read.csv("uphia2020hh.csv", header = TRUE)
  #roster   <- read.csv("uphia2020roster.csv", header = TRUE)
  #adultind <- read.csv("uphia2020adultind.csv", header = TRUE)
  #adultbio <- read.csv("uphia2020adultbio.csv", header = TRUE)
...
# 9. Estimate annual incidence    
    ...
    # Note that UPHIA incidence estimation uses different parameters than other PHIA countries
    ...
    omega <- 153 # Mean Duration of Recent Infection (MDRI)
    sig_omega2 <- 162.6926 # Standard error of MDRI
