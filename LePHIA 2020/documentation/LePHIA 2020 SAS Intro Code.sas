...
%let country  = Lesotho;    * country name;

%let survey   = lephia2020; * survey prefix;

%let numreps  = 168;        * the number of Jackknife replicate weights for the survey;
...
/*******************************************************************************
  3. Formating variables
     ...
     ---Approach 2. Using the PHIA permanent format library
		 This example assumes that the SAS program "LePHIA 2020 SAS Formats.sas" has been run. 
