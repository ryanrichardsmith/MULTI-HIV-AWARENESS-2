...
# 3. Read in data
#SAS file type
  hh        <- import ("lephia2020hh.sas7bdat")
  roster    <- import ("lephia2020roster.sas7bdat")
  adultind  <- import("lephia2020adultind.sas7bdat")
  adultbio  <- import("lephia2020adultbio.sas7bdat")

#csv file type
  #hh       <- read.csv("lephia2020hh.csv", header = TRUE)
  #roster   <- read.csv("lephia2020roster.csv", header = TRUE)
  #adultind <- read.csv("lephia2020adultind.csv", header = TRUE)
  #adultbio <- read.csv("lephia2020adultbio.csv", header = TRUE)
