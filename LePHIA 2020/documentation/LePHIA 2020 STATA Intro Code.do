...
*global country "Lesotho" //country name
*global survey lephia2020 			//survey prefix
*global weights "168" 		//Number of survey-specific jackknife replicate weights
...
//Adultbio
use "lephia2020adultbio.dta", clear
...
use "lephia2020adultind.dta", clear
merge 1:1 personid using lephia2020adultbio.dta
tab _merge 
drop _merge
...
use "lephia2020hh.dta", clear
merge 1:m householdid using lephia2020roster.dta

//Many-to-one
//Merge the individual dataset with the household dataset and only keep eligible and responding people
use "lephia2020adultind.dta", clear
merge m:1 householdid using lephia2020hh.dta
tab _merge 
drop _merge
